...
public class JobSeekerApplyService {
    ...
    // ✅ Implemented overloaded method
    public void addNew(JobSeekerProfile jobSeekerProfile, JobPostActivity jobPostActivity) {
        JobSeekerApply apply = new JobSeekerApply();
        apply.setUserId(jobSeekerProfile);
        apply.setJob(jobPostActivity);
        apply.setApplyDate(new java.util.Date()); // set current date
